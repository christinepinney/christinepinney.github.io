...
struct buddy_pool
{
    ...
    // KNUTH'S ALGO ASSUMES WE START AT ADDRESS 0, BUT WE DON'T
    struct avail avail[MAX_K];  /*The array of available memory blocks*/
    pthread_mutex_t lock;       /*For thread safety*/
    size_t numcalls;            /*To keep track of internal fragmentation*/
    size_t numalloc;          /*To keep track of internal fragmentation*/
    size_t numsplits;          /*To keep track of internal fragmentation*/
};
